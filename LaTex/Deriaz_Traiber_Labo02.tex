...
\newcommand{\professor}{Christophe Besson}
\newcommand{\assistant}{}
\newcommand{\cours}{Applied electromagnetics (AppElm)}
\newcommand{\titre}{Laboratoire 1}
...
\pagebreak
\subfile{construction_modele}
\pagebreak
\subfile{preparation_theorie}
\pagebreak
\subfile{fonctionnement_sans_courant}
\pagebreak
\subfile{fonctionnement_avec_courant}
\pagebreak
\subfile{conclusion}
